      ...
      <div className="mx-auto flex max-w-[1180px] flex-wrap items-start justify-between gap-6">
        ...
        <div className="flex flex-wrap gap-14">
          <div>
            ...
            <Link href="/" className="block py-2.5 text-sm md:py-1 text-[var(--ink-soft)] hover:text-[var(--accent-2)]">
              Inicio
            </Link>
          ...
          <div>
            ...
            {CATEGORIAS.map((c) => (
              <Link
                ...
                className="block py-2.5 text-sm md:py-1 text-[var(--ink-soft)] hover:text-[var(--accent-2)]"
              >
                {c.nombre}
              </Link>
            ))}
          ...
          <div>
            ...
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="flex items-center gap-1.5 py-2.5 text-sm md:py-1 text-[var(--ink-soft)] hover:text-[var(--accent-2)]"
            >
